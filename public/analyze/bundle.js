...
var analyzeGame = new CheckersGame();
analyzeGame.start();
var initialFen = analyzeGame.getFen();
var ai = new CheckersAi(analyzeGame);
window.addEventListener('load', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var mobileNavToggle, nav, gameId, res, resObj, moves, board, states, game, _loop, i, firstMove;
    return _regeneratorRuntime().wrap(function _callee$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 17:
          ...
          moves = resObj.moves.map(function (json) {
          ...
          _loop = /*#__PURE__*/_regeneratorRuntime().mark(function _loop(i) {
            var moveList, moveNumberNode, moveNode;
            return _regeneratorRuntime().wrap(function _loop$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  moveList = document.querySelector('#move-list');
                  if (i % 2 === 0) {
                    moveNumberNode = document.createElement("p");
                    moveNumberNode.innerHTML = "".concat(i / 2 + 1, ".");
                    moveList.appendChild(moveNumberNode);
                  }
                  moveNode = document.createElement("p");
                  moveNode.setAttribute('data-index', i);
                  moveNode.setAttribute('data-cy', "move-".concat(i));
                  ...
                  moveNode.addEventListener('click', function (e) {
                    if (states[i].bestMove === '') {
                      ...
                      var _ai$getNextMove = ai.getNextMove(),
                        _ai$getNextMove2 = _slicedToArray(_ai$getNextMove, 2),
                        bestMove = _ai$getNextMove2[0],
                        evaluation = _ai$getNextMove2[1];
                      if (bestMove) {
                    ...
                    if (states[i].evaluation === '') {
                      ...
                      var _ai$getNextMove3 = ai.getNextMove(),
                        _ai$getNextMove4 = _slicedToArray(_ai$getNextMove3, 2),
                        _bestMove = _ai$getNextMove4[0],
                        _evaluation = _ai$getNextMove4[1];
                      if (_bestMove && i + 1 < states.length) {
                        states[i + 1].bestMove = _bestMove;
                      }
                      states[i].evaluation = _evaluation;
                    }
                    var selectedMove = document.querySelector('#move-list .selected-move');
                    if (selectedMove) {
                    ...
                    board.drawBoard();
                    document.getElementById("eval").innerHTML = "eval: ".concat(states[i].evaluation, ". Best Move: ").concat(states[i].bestMove.longNotation);
                  });
        ...
        case 26:
          ...
          return _context2.delegateYield(_loop(i), "t0", 28);
        case 28:
          i++;
          _context2.next = 26;
          break;
        case 31:
          firstMove = document.querySelector('[data-index="0"]');
          if (firstMove) {
            firstMove.click();
          }
          board.toggleNumbers();
...
},{"../CheckersAi":1,"../CheckersBoard":2,"../CheckersGame":3,"../challenge":6}],6:[function(require,module,exports){
"use strict";
